<%-- 
    Document   : viewToday
    Created on : Mar 3, 2021, 11:42:19 PM
    Author     : Camille
--%>
...
<html>
    ...
    <body>
        ...
        <div class="pageHeader">
            <p id="pageHeader">View TODAY'S Records</p>
        </div>
        <div class="search">
            <form method="post" action="RecordsServlet">
                ...
                <input type="hidden" name ="searchCheck" value="today">
                <input type="submit" align="center" value="Search" name="view" class="searchtext">
            </form>
        </div>
            ...
            <table align="center" id="table">
                ...
                <div class="modal-content">
                    ...
                    <form method = "POST" action="RecordsServlet">
                        ...
                        <input type="hidden" name="deleteCheck" value="today">
        ...
        <div id='bottomButtons'>
            ...
            <div class ="button">
                <form method="post" action="RecordsServlet">
                    <input type="hidden" name="viewCheck" value="today">
