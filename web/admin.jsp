<%-- 
    Document   : home
    Created on : Feb 8, 2021, 6:40:04 PM
    Author     : Camille
--%>
...
<html>
    ...
    <body>
        ...
        <div class="main">
            ...
            <br>
            <form class="pic" method="post" action="LoginAdminServlet" autocomplete="off">
                <div>
                    <input class="un" style="width: 290px" type="text" placeholder="Username" name="username" required>
                    <br/>
                    <br/>
                    <input class="pass" style="width: 290px" type="password" placeholder="Password" name="password" required>
                    <br/>
                    <br/>
